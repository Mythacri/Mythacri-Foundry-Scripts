...
export class Crafting {
  ...
  static validIdentifier(id) {
    ...
    if (type !== "monster") {
      if (subtype === "*") return type in types;
      return foundry.utils.hasProperty(types, path);
    }

    // Special handling for monster parts.
    const validSubsub = (subsubtype === "*") || (subsubtype in Crafting.subsubtypes);
    return validSubsub && ((subtype === "*") || (subtype in CONFIG.DND5E.creatureTypes));
  }
